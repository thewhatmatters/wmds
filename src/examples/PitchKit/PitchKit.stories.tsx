  ...
  parameters: withStoryCopySource(
    {
      docs: {
        description: {
          story:
            "Show code is the product contract when Graph returned Insights but demographic series are missing or empty — no country, city, age, or gender breakdown to rank. Reach, Stats, and proof may still show. This is not whole-page Graph unavailable. Keep the Audience Card in the Insights dashboard grid with the same header; the well is the empty Pattern. Do not hide the band, do not invent example percentages, do not use Skeleton or Chart.Loading, and do not draw RankedBars from an empty series. Honest 0 only when Graph returned zero. Copy that source into PitchKit. Do not reconstruct from PitchKitExample / pitchKitStyles, and do not ship ExampleGridControls.",
        },
      },
    },
    `
...
export const InsufficientReachAndAudienceData: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          "Both the reach series and demographic series are unusable. Keep both Cards in the Insights dashboard grid with the same headers; each well is that band’s empty Pattern. Copy State — insufficient reach data for the Reach well and State — insufficient audience data for the Audience well. Do not omit either band, do not invent a chart or example percentages, and do not use Skeleton or Chart.Loading for these empties.",
      },
    },
  },
};
