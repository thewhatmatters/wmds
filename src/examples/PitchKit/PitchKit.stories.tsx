...
5. **Outreach** — display-only **Contact** on **Pattern — owner PitchKit**. Past brands display copies **Pattern — past brands (public)**. Add / edit / reorder copies **Pattern — past brands (owner)**.
