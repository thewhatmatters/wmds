...
Long-scroll is demoed in a short panel on **Components/Navigation/SiteNav**. This Example shows page composition: **SiteNav** + \`grid-page\` hero.
            ...
            <SiteNav.Menu label="Resources">
              <SiteNav.MenuSection label="Read" span={2}>
                <SiteNav.MenuLinkGrid>
                  <SiteNav.MenuLink href="#blog" icon={<Newspaper />}>
                    Blog
                  </SiteNav.MenuLink>
                  <SiteNav.MenuLink href="#docs" icon={<BookOpen />}>
                    Documentation
                  </SiteNav.MenuLink>
                  <SiteNav.MenuLink href="#community" icon={<Users />}>
                    Community
                  </SiteNav.MenuLink>
                </SiteNav.MenuLinkGrid>
              </SiteNav.MenuSection>
  ...
  parameters: withStoryCopySource(
    {
      docs: {
        description: {
          story:
            "Page composition with SiteNav. Scroll collapse lives in the SiteNav Pattern story’s short panel. Press G for grid guides and T to cycle theme.",
        },
      },
    },
    `
