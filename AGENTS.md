...
- **Theme tokens:** Astryx-aligned roles in **`src/theme/colors.css`**; typography in **`src/theme/typography.css`** (`type-*` utilities, geometric scale); motion in **`src/theme/motion.css`**. See **ADR-0007**, **ADR-0008**, **ADR-0009**. Use **`typographyClass()`** — not raw `text-sm` in document copy.
