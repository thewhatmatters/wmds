...
| `Card` | `variant`, `shape`, `padding` | Molecules/Card — `Card.Header` (`title`, `subtitle`, `end`), **`Card.Body` slot** (no default fill), `Card.Footer`; optional occupant well `cardBodyWellClasses` |
